...
# Stage 2: Backend with minimal LaTeX
# Using Debian slim instead of texlive/texlive:latest (5GB+) for much smaller image size
FROM debian:bookworm-slim AS backend

# Install minimal LaTeX packages and Bun
